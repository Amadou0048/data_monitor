...
class _EntryPageWidgetState extends State<EntryPageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Esp32controlRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<Esp32controlRecord> entryPageEsp32controlRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final entryPageEsp32controlRecord =
            entryPageEsp32controlRecordList.isNotEmpty
                ? entryPageEsp32controlRecordList.first
                : null;
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            0.0, 10.0, 0.0, 10.0),
                        child: Text(
                          'Bienvenue sur l\'interface de supervision de données By Thérèse&Amadou',
                          textAlign: TextAlign.center,
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    fontFamily: 'Readex Pro',

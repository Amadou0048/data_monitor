          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  StreamBuilder<List<Esp32controlRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<Esp32controlRecord> buttonEsp32controlRecordList =
                          snapshot.data!;
                ...
                ].divide(const SizedBox(width: 50.0)).around(const SizedBox(width: 50.0)),
              ),
              Align(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return Column(
                                  ...
                                  children: List.generate(
                                      columnVoltageAcquisitionRecordList.length,
                                      (columnIndex) {
